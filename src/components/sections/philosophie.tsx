...
export function Philosophie() {
  return (
    <section id="philosophie" className="scroll-mt-24 bg-sand py-[var(--spacing-sektion)]">
      <div className="inhalt">
        ...
        <div className="mt-4 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,22rem)] lg:gap-20">
          <ZeilenReveal as="h2" className="t-titel max-w-[24ch]">
        ...
        <dl className="mt-14 grid gap-px border-t border-greige/60 sm:grid-cols-2 lg:grid-cols-4">
          {philosophie.map((punkt) => {
            ...
            return (
              ...
              >
                <Symbol size={26} strokeWidth={1} className="text-kupfer-tief" aria-hidden />
                <dt className="font-display mt-5 text-2xl font-light">{punkt.titel}</dt>
                <dd className="mt-2 text-sm leading-relaxed text-tinte/80">{punkt.text}</dd>
              </div>
            )
          })}
        </dl>
